...
class CenterHead(BaseModule):
    ...
    def __init__(self,
        ...
        self.use_shared_feat = use_shared_feat
    ...
    def forward(self, feats):
        ...
        """
        return multi_apply(self.forward_single, feats), self.shared_feat # 调用forward_single函数（对于centerpoint实际只有一个尺度）
