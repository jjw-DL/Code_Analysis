    ...
    for info in mmcv.track_iter_progress(nusc_infos):
        for cam in camera_types:
            ...
            for coco_info in coco_infos:
                ...
                coco_2d_dict['annotations'].append(coco_info) # 添加标注字段
                coco_ann_id += 1
    if mono3d:
...
def get_2d_boxes(nusc,
    ...
    for ann_rec in ann_recs:
        ...
        ann_rec['sample_annotation_token'] = ann_rec['token'] # 在ann_rec中增加sample_annotation_token字段
        ann_rec['sample_data_token'] = sample_data_token # 在ann_rec中增加sample_data_token字段
        ...
        corners_3d = corners_3d[:, in_front] # 获取深度大于0的box前视角点
        ...
        if mono3d and (repro_rec is not None):
            ...
            center3d = np.array(loc).reshape([1, 3]) # cam系下的3d中心位置
            center2d = points_cam2img(
                center3d, camera_intrinsic, with_depth=True) # 将中心点从cam系变换到img系的2d位置，包含深度
