...
model = dict(
    type='DynamicCenterPointRCNN',
    init_cfg=dict(type='Pretrained', checkpoint='/home/vci/Det3D_New/mmdetection3d/checkpoints/dycen.pth'),
...
data_root = '/home/vci/Disk_Data/nuscenes/'
input_modality = dict(
    use_lidar=True,
    use_camera=False,
    use_radar=False,
...
# load_from = '/home/vci/Det3D_New/mmdetection3d/checkpoints/dycen.pth'