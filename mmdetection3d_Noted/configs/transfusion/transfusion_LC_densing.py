...
data = dict(
    ...
    test=dict(
        ...
        painted=True))
model = dict(
    type='DynamicTransFusionDetector',
    init_cfg=dict(type='Pretrained', checkpoint='/home/vci/Det3D_New/mmdetection3d/checkpoints/dynamic_transfusion_L_densed_20.pth'),
    img_backbone=dict(
        type='ResNet',
        depth=50,
        num_stages=4,
        ...
        norm_eval=True,
        style='pytorch',
        init_cfg=dict(type='Pretrained', checkpoint='/home/vci/Det3D_New/mmdetection3d/checkpoints/htc_r50_fpn_coco-20e_20e_nuim_20201008_211415-d6c60a2c.pth', prefix='backbone')),
    img_neck=dict(
        type='FPN',
        in_channels=[256, 512, 1024, 2048],
        out_channels=256,
        num_outs=5,
        init_cfg=dict(type='Pretrained', checkpoint='/home/vci/Det3D_New/mmdetection3d/checkpoints/htc_r50_fpn_coco-20e_20e_nuim_20201008_211415-d6c60a2c.pth', prefix='neck')),
