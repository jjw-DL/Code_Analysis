...
class RPN(nn.Module):
    def __init__(
        ...
        **kwargs
        ...
        self._layer_strides = ds_layer_strides # [1, 2]
        self._num_filters = ds_num_filters # [128, 256]
        self._layer_nums = layer_nums # [5, 5]
        self._upsample_strides = us_layer_strides # [1, 2]
        self._num_upsample_filters = us_num_filters # [256, 128]
        self._num_input_features = num_input_features # 640
        ...
        in_filters = [self._num_input_features, *self._num_filters[:-1]] # 640, 128
        blocks = []
        deblocks = []
