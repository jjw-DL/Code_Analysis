...
class Detr3DHead(DETRHead):
    ...
    def __init__(self,
        ...
        self.num_cls_fcs = num_cls_fcs - 1 # 2 - 1 = 1
    ...
    def forward(self, mlvl_feats, img_metas):
        ...
        hs, init_reference, inter_references = self.transformer(
            mlvl_feats,
            query_embeds,
            reg_branches=self.reg_branches if self.with_box_refine else None,  # 6个回归分支
            img_metas=img_metas,
        )
    ...
    def _get_target_single(self,
        ...
        # bbox targets
        bbox_targets = torch.zeros_like(bbox_pred)[..., :9] # (900, 10) 全0初始化
    ...
    def loss(self,
        ...
        gt_bboxes_list = [torch.cat(
            ...
            dim=1).to(device) for gt_bboxes in gt_bboxes_list] # (45, 9) --> lyft这里增加2个维度(速度)
