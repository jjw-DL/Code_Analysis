        ...
        if self.pad_empty_sweeps and len(results['sweeps']) == 0:
            ...
            for idx in choices:
                ...
                for sensor in self.sensors:
                    results['lidar2img'].append(np.array(sweep[sensor]['lidar2img']))
                    results['intrinsics'].append(np.array(sweep[sensor]['intrinsics']))
                    results['extrinsics'].append(np.array(sweep[sensor]['extrinsics']))
