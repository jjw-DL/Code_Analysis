...
model = dict(
    ...
    img_backbone=dict(
        ...
        init_cfg=dict(type='Pretrained', checkpoint='/mnt/lustre/jiangjingwen/checkpoints/fcos3d_r50.pth', prefix='backbone')),
    img_neck=dict(
        type='FPN',
        ...
        init_cfg=dict(type='Pretrained', checkpoint='/mnt/lustre/jiangjingwen/checkpoints/fcos3d_r50.pth', prefix='neck')),
    pts_bbox_head=dict(
        type='Detr3DHead',
        num_query=900,
        num_classes=10,
