...
class RedundancyModule:
    def __init__(self, configs):
        ...
        self.mode = configs['redundancy']['mode'] # default
        self.asso = configs['running']['asso'] # giou
        self.det_score = configs['redundancy']['det_score_threshold'][self.asso] # 0.01
        self.det_threshold = configs['redundancy']['det_dist_threshold'][self.asso] # -0.5
