...
def import_codebase(codebase: Codebase):
    ...
    """
    codebase_name = codebase.value # eg:mmdet3d
    dependent_library = [codebase_name] + \
        extra_dependent_library.get(codebase, []) # ['mmdet3d']
    ...
    for lib in dependent_library:
        ...
        importlib.import_module(f'mmdeploy.codebase.{lib}') # mmdploy.codebase.mmdet3d
