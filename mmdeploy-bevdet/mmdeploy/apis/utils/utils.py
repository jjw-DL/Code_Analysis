...
def build_task_processor(model_cfg: mmcv.Config, deploy_cfg: mmcv.Config,
    ...
    codebase_type = get_codebase(deploy_cfg) # eg:mmdet3d
    import_codebase(codebase_type) # 通过importlib的import_module导入mmdeploy.codebase.mmdet3d库
    codebase = get_codebase_class(codebase_type) # 获取mmdeploy.codebase.mmdet3d.deploy.mmdetection3d.MMDetection3d
